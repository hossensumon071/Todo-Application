const AddTask = () => {
  return (
    <form className="bg-gray-900 container mx-auto flex justify-between p-10">
      ...
      />
      <button type="submit" className="bg-teal-900/30 py-2 px-5 border-2 border-teal-500 rounded text-teal-500 hover:bg-teal-500 hover:text-gray-900 duration-300">
        Add Task
      </button>
    </form>
  );
